...
onready var textures = [
	load("res://Assets/bluspark_00004.png")
	,load("res://Assets/bluspark_00009.png")
	,load("res://Assets/bluspark_00017.png")
	,load("res://Assets/bluspark_00022.png")
]
...
func die():
	...
	if HUD.blocks_fall:
		...
		$Tween.start()
	if HUD.blocks_fade:
		$Tween.interpolate_property($Color, "color", $Color.color, target_color, fall_duration-0.05, Tween.TRANS_EXPO, Tween.EASE_IN)
		$Tween.start()
